...
export class Employee extends Component {
  ...
  refreshList() {
    fetch(variables.API_URL + "Employees")
      ...
      .then((data) => {
        this.setState({ employees: data.data, departmentsWithoutFilter: data });
      });
  }
  ...
  render() {
    const { employees, modalTitle, id, name, phone, email, address } =
      this.state;
          ...
          <div className="modal-dialog modal-lg modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <div className="input-group mb-3">
                  <span className="input-group-text">Vai trò</span>
                  <MyComponent />
                </div>
